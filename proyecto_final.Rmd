...
Vamos a entender la segmentacion de clientes para caracterizarlos y estar preparados para tener en los hoteles la preparación para cada segmento de clientes tomando en cuenta solamente las variables de tipo numéricas.
```{r Analisis de conglomerados}
data.cluster <- dist(data.select)
