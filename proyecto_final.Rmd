...
## Test de normalidad
Aplicaremos la prueba de anderson-darling, pero antes generaremos una muestra de ellos
...
dependent.vars <- cbind(data.numerical)

comp.manova <- summary(manova(dependent.vars ~ data$Temperature))
